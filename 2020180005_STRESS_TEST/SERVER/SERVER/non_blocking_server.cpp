...
{
    unique_lock lock(sessions_mutex);
...
void CALLBACK recv_callback(DWORD err, DWORD bytes, LPWSAOVERLAPPED ov, DWORD) 
{
    int sid = static_cast<int>(reinterpret_cast<long long>(ov->hEvent));
